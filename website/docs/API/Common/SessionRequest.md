...
<div class="field-card">
<h3>`request`: <span className="type-link">[`SessionRequestType`](/docs/API/Common/SessionRequestType)</span> <div style={{ float: "right", color: "#888888", fontSize: '10pt', fontWeight: "400" }}>Mandatory</div></h3>
The type of request
